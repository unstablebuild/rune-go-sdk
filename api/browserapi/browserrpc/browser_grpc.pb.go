...
const (
	...
	WindowManager_SetTabName_FullMethodName     = "/browser.WindowManager/SetTabName"
)
...
type WindowManagerClient interface {
	...
	SetTabName(ctx context.Context, in *SetTabNameRequest, opts ...grpc.CallOption) (*SetTabNameResponse, error)
}
...
func (c *windowManagerClient) SetTabName(ctx context.Context, in *SetTabNameRequest, opts ...grpc.CallOption) (*SetTabNameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetTabNameResponse)
	err := c.cc.Invoke(ctx, WindowManager_SetTabName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WindowManagerServer interface {
	...
	SetTabName(context.Context, *SetTabNameRequest) (*SetTabNameResponse, error)
...
func (UnimplementedWindowManagerServer) SetTabActivity(context.Context, *SetTabActivityRequest) (*SetTabActivityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetTabActivity not implemented")
}
func (UnimplementedWindowManagerServer) SetTabName(context.Context, *SetTabNameRequest) (*SetTabNameResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetTabName not implemented")
}
...
func _WindowManager_SetTabName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetTabNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WindowManagerServer).SetTabName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WindowManager_SetTabName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WindowManagerServer).SetTabName(ctx, req.(*SetTabNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WindowManager_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetTabName",
			Handler:    _WindowManager_SetTabName_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
