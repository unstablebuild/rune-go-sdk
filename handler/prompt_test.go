...
func TestPromptMouseClick(t *testing.T) {
	...
	// Find button coordinates. After Resize(20, 10) with
	// "Yes" (frame=7) and "No" (frame=6), gap=2, total=15:
	// startX = (20-15+1)/2 = 3.
	// "Yes" button: x=[3,9], y=7..9 (3 rows for frame)
	// "No" button: x=[12,17], y=7..9
	const (
